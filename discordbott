...
bot.on('ready', () =>{
    console.log('Forza bot is online!');
        bot.user.setActivity("Forza Server, bot made by: Hicham#3335", {type: "WATCHING"}).catch(console.error);
})
...
bot.login(process.env.NjQxNzEwODcwODU4MTcwMzg4.Xcqv-A.Ivzv0q5boqTHtbUFR34VdrII-c8);
